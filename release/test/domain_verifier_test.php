...
$bofa_json = file_get_contents('fixtures/verified.json');
$wf_json = file_get_contents('fixtures/wf.json');
$github_json = file_get_contents('fixtures/github.json');
$coinbase_json = file_get_contents('fixtures/coinbase.json');
$colu_json = file_get_contents('fixtures/colu.json');
$bcinfo_json = file_get_contents('fixtures/blockchaininfo.json');
$colu_2nd_asset_json = file_get_contents('fixtures/colu_2nd_asset.json');
$colu_fake_asset_json = file_get_contents('fixtures/colu_fake_asset.json');
$blank_url_json = file_get_contents('fixtures/blank_url.json');
$fake_url_json = file_get_contents('fixtures/fake_url.json');
